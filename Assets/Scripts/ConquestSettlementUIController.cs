...
public class ConquestSettlementUIController : MonoBehaviour
{
    [SerializeField]
    ...
    public void Initialized(EventData eventData)
    {
        ...
        String tmp_winTeam = (string) tmp_SettlementData[0];
        int tmp_teamBlueRebornCount = (int)tmp_SettlementData[1];
        ...
        {
            EndingHint.text = tmp_winTeam.Equals(PhotonNetwork.LocalPlayer.GetPhotonTeam().Name) ? "胜利" : "落败";
        }
        _canvas1.SetActive(false);
